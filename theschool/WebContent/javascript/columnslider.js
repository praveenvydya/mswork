...
buildpaginate:function(setting){
	...
	if (setting.autorotate[0]) { //µ±ÉèÖÃÎª×Ô¶¯ÂÖ»»Ê±£¬¼´ autorotate Îª true Ê± 
	    pdiv[setting.revealtype] = function() {
	        return false;
	    };
	    pdiv["onmouseover"] = function() {
	        featuredcontentslider.cleartimer(setting, window["fcsautorun" + setting.id]); // onmouseover£¬Í£Ö¹×Ô¶¯ÂÖ»» 
	        return true;
	    };
	    pdiv["onmouseout"] = function() {
	        featuredcontentslider.autorotate(setting); // onmouseout ºó£¬¼ÌÐø×Ô¶¯ÂÖ»» 
	        return true;
	    };
	    ...
	    setting.autorotate[1] = setting.autorotate[1] + (1 / setting.enablefade[1] * 80); //Ìí¼ÓÂÖ»»Í£ÁôÊ±¼ä 
...
turnpage:function(setting, thepage, autocall){
	...
	setting.contentdivs[turntopage-1].style.zIndex=10
