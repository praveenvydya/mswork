...
jQuery.tableDnD = {
    ...
    mouseup: function(e) {
        if (jQuery.tableDnD.currentTable && jQuery.tableDnD.dragObject) {
            ...
            var debugStr = "";
            for (var i=0; i<rows.length; i++) {
            	debugStr += rows[i].cells[0].firstChild.id+",";                
            }
           // alert("IDS "+debugStr);
           // alert("element "+document.getElementById("reorderedIds"));
            document.getElementById("reorderedIds").value = debugStr;
           // alert("element "+document.getElementById("reorderedIds").value);
            for (var i=0; i<rows.length; i++) {
                if(i % 2 == 0)
                {
