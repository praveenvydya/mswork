...
<p>
	Welcome:&nbsp;<strong>${sessionScope.user_display_name}</strong> &nbsp;
	| &nbsp; <a
		href="${pageContext.servletContext.contextPath}/user/logout.htm"
		class="logoutLink">Logout</a>
</p>


<p class="lastLogin">User TYpe: ${sessionScope.user_type}</p>
</span>
<div>Hello ${student.firstName} ${student.lastName}</div>
<div id="tabularData">
	<div id="sectionBttns"></div>
	<div>
			<div class="secTable">
				<table border="0" cellspacing="0" cellpadding="0" id="">
						...
						<td>
							<div>
								...
								<div class="sec" style="float: right;">
									<img
										src="${pageContext.request.contextPath}/static/simg-fit/117x155/${student.unid}.jpeg"
										class="" alt="" />
								</div>
							</div>
						</td>
					...
					<tr>
						...
						<td><a
							href="${pageContext.servletContext.contextPath}/user/student/attendance.htm?st=${student.studentId}"
							id="att_${student.studentId}" class="cms-btn att">Attendance</a>
						<td>
					</tr>
				</table>
			</div>
