...
<link href="<spring:message code="static.application.name"/>/css/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="<spring:message code="static.application.name"/>/css/autoptimize.css" rel="stylesheet" type="text/css" />
