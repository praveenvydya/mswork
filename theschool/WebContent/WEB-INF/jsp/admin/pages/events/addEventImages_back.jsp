		...
		<div class="">
			<form:form enctype="multipart/form-data" name="galleryImageForm"
				...
				<table width="500" border="0" cellspacing="0" cellpadding="2">
					...
					<tr>
						<td>Gallery Image<span class="mandatory">*</span>
						</td>
						<td><form:input multiple="" type="file" path="files" class="upload" /> <br>
						<form:errors path="files" cssClass="errormsg" /><span
							class="errormsg" id="fileError"></span>
						</td>
					</tr>
					<tr>
						<td>Description<span class="mandatory">*</span>
						</td>
						<td colspan="2"><form:input type="text" path="description"
								class="searchTextBoxes" /> <br>
						<form:errors path="description" cssClass="errormsg" /><span
							class="errormsg" id="descriptionError"></span>
						</td>
					</tr>
					<tr>
						<td>Gallery Name<span class="mandatory">*</span>
						</td>
