...
<form:hidden path="" id="selectedRoleType"/>   
 ...
 <form:hidden path="adminRoleFlag" id="adminRoleFlag"/> 
      <div id="tabularData">
        ...
        <div id="isUserRole" style="display:${'Individual Administrator' eq role.roleType ? 'block' : 'none' }"><table width="100%" border="0" cellspacing="0" cellpadding="5" >
        <tr>
            <td width="13%" nowrap="nowrap">&nbsp;  User Role Required:</td>
            <td width="38%"><form:checkbox path="userRoleRequired" value='true' id='userRoleRequired' name='userRoleRequired'/>
            </td>
            <td width="10%">&nbsp;</td>
            <td width="39%">&nbsp; </td>
          </tr></table> 
