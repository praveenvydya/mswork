...
function processImageData(data){
	...
	var bl = rm.toDataURL(imageType);
	var imageBlob = rm.toDataURL().replace("data:"+imageType+";base64,","");
	//$('#imageString').val(imageBlob);
...
function displayCroped(data){
	...
	$('#croped-image').attr('src',can.toDataURL(imageType));
